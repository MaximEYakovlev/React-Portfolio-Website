    ...
    <div className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <h1 className="i-name">Maxim Yakovlev</h1>
          ...
          <p className="i-desc">
            ...
            faucibus ornare suspendisse sed nisi lacus sed. Dignissim enim sit
            amet venenatis urna cursus. Aliquet lectus proin nibh nisl. Sit amet
